...
const TEAID_GCMD_OPEN_RAVNKLOA = "72";
const TEBID_GCMD_OPEN_VESTREKANALKAI = "b2";
const TEAID_GCMD_CLOSE_RAVNKLOA = "73"
const TEBID_GCMD_CLOSE_VESTREKANALKAI = "b3"
const BCOMP_RAVNKLOA = ""
const BCOMP_VESTREKANALKAI =""
...
function Serial_SAM_RXD(SAMdataRX){
  ...
  switch (SAMdataRX){
    ...
    case REQF_VESTREKANALKAI:
      //Unused for RK
      break;
    case TEAID_GCMD_OPEN_RAVNKLOA:
      io.emit("SAM_data",SAMdataRX);
      break;
    case TEBID_GCMD_OPEN_VESTREKANALKAI:
      io.emit("SAM_data",SAMdataRX);      
      break;
    case TEAID_GCMD_CLOSE_RAVNKLOA:
      io.emit("button_data", false);
      break;
    case TEBID_GCMD_CLOSE_VESTREKANALKAI:
      io.emit("SAM_data",SAMdataRX); 
      //Unused for RK
      break;
    default:
